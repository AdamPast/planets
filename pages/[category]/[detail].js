...
const Detail = ({ content }) => {
    ...
    return (
        <StyledContainer>
            <StyledHeader>
                <Link href={`/${content.category.name}`} passHref><StyledLink>← Powrót</StyledLink></Link>
                <StyledTitle></StyledTitle>
                <Link href="/" passHref><StyledLink>Menu</StyledLink></Link>
            </StyledHeader>
            <StyledContent>
                  ...
                  <StyledList>
                    {detailsInfo.map((detail, i) => {
                        if(detail.value == undefined){
                            ...
                            return <StyledListItem key={i}>{detail.name}: {detail.value}</StyledListItem>
                        } 
                    })}
                  </StyledList>                 
                </StyledDetails>
